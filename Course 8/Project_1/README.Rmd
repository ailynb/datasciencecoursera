...
An overall pseudo-random number generator seed was set at 1234 for all code. In order to reproduce the results below, the same seed should be used. Different packages were downloaded and installed, such as caret, ggplot2 and randomForest. These should also be installed in order to reproduce the results below (please see code below for ways and syntax to do so).
...
```
The variable "classe" is a factor variable with 5 levels (Class A: Sitting, Class B: Sitting down, Class C: Standing, Class D: Standing up, Class E: walking)
